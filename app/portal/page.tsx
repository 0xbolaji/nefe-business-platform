  ...
  return (
    <main className="portal-page min-h-screen bg-[#F7F6FA] text-[#19152A]">
      ...
      <aside className="fixed inset-y-0 left-0 z-40 hidden w-[248px] flex-col border-r border-[#EAE6EF] bg-white px-4 py-6 lg:flex">
        ...
        <Link href="/why-botchain" className="mt-1 flex items-center gap-3 px-3 py-2 text-[10px] font-semibold text-[#7A7282] transition hover:text-[#5E3BEE]"><span>◎</span>Why Botchain<span className="ml-auto">→</span></Link>
