  ...
  return (
    <main className="portal-page min-h-screen bg-[#F7F6FA] text-[#19152A]">
      ...
      <aside className="fixed inset-y-0 left-0 z-40 hidden w-[248px] flex-col border-r border-[#EAE6EF] bg-white px-4 py-6 lg:flex">
        ...
        <Link href="/executive-insights" className="mt-2 flex items-center gap-3 rounded-xl border border-[#E6E1EA] bg-white px-3 py-3 text-[11px] font-semibold text-[#4F4858] transition hover:-translate-y-0.5 hover:border-[#D0C4F7] hover:text-[#5E3BEE] hover:shadow-sm"><Icon name="analytics" className="h-4 w-4 text-[#5E3BEE]" />Executive Insights<span className="ml-auto">→</span></Link>
        <Link href="/commerce-graph" className="mt-2 flex items-center gap-3 rounded-xl bg-gradient-to-r from-[#211640] to-[#5332C5] px-3 py-3 text-[11px] font-semibold text-white shadow-[0_10px_24px_rgba(62,38,138,.16)] transition hover:-translate-y-0.5 hover:shadow-lg"><span className="text-[#E1C16A]">✦</span>Commerce Graph<span className="ml-auto">→</span></Link>
        <Link href="/founder-room" className="mt-2 flex items-center gap-3 px-3 py-2 text-[10px] font-semibold text-[#7A7282] transition hover:text-[#5E3BEE]"><span>◈</span>Founder Room<span className="ml-auto">→</span></Link>
        <Link href="/roi-calculator" className="mt-1 flex items-center gap-3 px-3 py-2 text-[10px] font-semibold text-[#7A7282] transition hover:text-[#5E3BEE]"><span>↗</span>ROI Calculator<span className="ml-auto">→</span></Link>
        <Link href="/technology" className="mt-1 flex items-center gap-3 px-3 py-2 text-[10px] font-semibold text-[#7A7282] transition hover:text-[#5E3BEE]"><span>◎</span>Technology<span className="ml-auto">→</span></Link>
        <Link href="/admin" className="mt-1 flex items-center gap-3 rounded-xl bg-[#171221] px-3 py-2.5 text-[10px] font-semibold text-white transition hover:bg-[#292038]"><span className="text-[#C4AEF8]">⌘</span>Admin Command Center<span className="ml-auto">→</span></Link>
        ...
        <header className="sticky top-0 z-30 border-b border-[#EAE6EF] bg-white/85 backdrop-blur-xl">
          <div className="flex h-[72px] items-center justify-between px-4 sm:px-7 lg:px-9">
            ...
            <div className="flex items-center gap-2 sm:gap-3">
              ...
              <Link href="/executive-insights" className="hidden rounded-xl border border-[#E4DFE9] bg-white px-3 py-2.5 text-[10px] font-semibold text-[#665F6E] transition hover:border-[#C9BCF6] hover:text-[#5E3BEE] xl:block">Executive Insights</Link>
              <Link href="/commerce-graph" className="hidden rounded-xl bg-[#211831] px-3 py-2.5 text-[10px] font-semibold text-white transition hover:bg-[#35234F] 2xl:block">Commerce Graph</Link>
