      ...
      <section className="hero-bg relative">
        <nav className="page-shell flex h-20 items-center justify-between">
          ...
          <div className="hidden items-center gap-8 text-sm font-medium text-[#5F5A70] md:flex">
            <a href="#platform" className="nav-link">Platform</a><a href="#solutions" className="nav-link">Solutions</a><a href="#how-it-works" className="nav-link">How it works</a><a href="#company" className="nav-link">Company</a>
          </div>
