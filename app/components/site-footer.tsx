...
const platformLinks = [["Platform","/platform"],["Opportunity Engine","/opportunity-engine"],["Business Model","/business-model"],["Commerce Graph","/commerce-graph"],["UAE Opportunity Map","/uae-opportunity-map"],["ROI Calculator","/roi-calculator"],["Business Portal","/business-portal"],["Consumer App","/consumer"],["Experience Builder","/experience-builder"]];
