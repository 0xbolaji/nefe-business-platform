...
const platformLinks = [["Platform","/platform"],["Pricing","/pricing"],["Business Model","/business-model"],["Financial Model","/financial-model"],["Token Utility","/token-utility-economics"],["Opportunity Engine","/opportunity-engine"],["Commerce Graph","/commerce-graph"],["UAE Opportunity Map","/uae-opportunity-map"],["ROI Calculator","/roi-calculator"],["Business Portal","/business-portal"],["Consumer App","/consumer"],["Experience Builder","/experience-builder"]];
