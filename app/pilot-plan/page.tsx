...
export default function PilotPlanPage() {
  return <main className="overflow-hidden bg-[#FAF9FB] text-[#19152A]">
    ...
    <section className="mx-auto max-w-[1240px] px-5 py-24 sm:px-8 sm:py-32">
      <div className="eyebrow">01 · Pilot Scope</div><h2 className="mt-6 max-w-3xl text-4xl font-semibold tracking-[-.05em] sm:text-5xl">Focused enough to control.<br/><span className="text-[#9A93A0]">Large enough to prove value.</span></h2>
