      ...
      <div className="page-shell relative py-14 sm:py-20">
        ...
        <div className="mt-8 grid gap-8 lg:grid-cols-[1fr_auto] lg:items-end">
          <div>
            ...
            <p className={`mt-4 text-[11px] ${merchant.ceo ? "text-white/45" : "text-[#817A87]"}`}>{merchant.location}, {merchant.city} · Verified UAE opportunity</p>
          </div>
