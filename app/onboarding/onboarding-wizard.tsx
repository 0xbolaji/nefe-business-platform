...
export default function OnboardingWizard() {
  ...
  return <main className="onboarding-page min-h-screen text-[#19152A]">
    <header className="relative z-20 mx-auto flex h-20 max-w-[1280px] items-center justify-between px-5 sm:px-8"><Logo/><div className="flex items-center gap-3"><span className="hidden text-[9px] text-[#96909C] sm:block">Already a partner?</span><Link href="/business-portal" className="rounded-xl border border-[#E1DCE6] bg-white/75 px-4 py-2.5 text-[9px] font-semibold text-[#5B5463] shadow-sm backdrop-blur transition hover:border-[#C8BAF6] hover:text-[#5E3BEE]">View portal</Link></div></header>
