...
export default function OnboardingWizard() {
  ...
  return <main className="onboarding-page min-h-screen text-[#19152A]">
    <header className="relative z-20 mx-auto flex h-20 max-w-[1280px] items-center justify-between px-5 sm:px-8"><Logo/><div className="flex items-center gap-2 sm:gap-3"><span className="hidden text-[9px] text-[#96909C] md:block">Already have an account?</span><Link href="/sign-up" className="hidden rounded-xl px-3 py-2.5 text-[9px] font-semibold text-[#5E3BEE] transition hover:bg-white/75 sm:inline-flex">Create account</Link><Link href="/sign-in" className="rounded-xl border border-[#E1DCE6] bg-white/75 px-4 py-2.5 text-[9px] font-semibold text-[#5B5463] shadow-sm backdrop-blur transition hover:border-[#C8BAF6] hover:text-[#5E3BEE]">Sign in</Link></div></header>
